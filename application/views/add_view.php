...
<body>
	...
	<div id="main">
	  ...
	  ?>
		...
		<?= form_open('/add',array('id'=>'create')) ?>
			<div class="input-wrap">
				<input type="text" name="destination" id="destination" autocomplete="off" placeholder="destination" class="no-input" />
			</div>

			<div class="input-wrap">
        <input type="text" name="custom" id="custom" autocomplete="off" placeholder="custom" class="no-input" />
			</div>
			<table cellspacing="0">
				<tr>
					<td align=center valign=top>
						<button type="submit" id=""><span>Make</span></button>
					</td>
				</tr>
			</table>
		<?= form_close() ?>
